...
#stn9 = ax9.text(-107.02, 38.40, 'GUC', transform=ccrs.Geodetic(), color='darkorange')
...
#
#text3 = ax3.text(0.50, 0.93, time_string,
...
filename90="/whirlwind/goes17/grb/meso_ircm/latest_meso_2s.jpg"
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_ircm/latest_meso_2.jpg")
...
thefile = open('/whirlwind/goes17/grb/meso_ircm/meso_2_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_ircm/meso_2_30_temp.list','/whirlwind/goes17/grb/meso_ircm/meso_2_30.list')

thefile = open('/whirlwind/goes17/grb/meso_ircm/meso_2_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_ircm/meso_2_60_temp.list','/whirlwind/goes17/grb/meso_ircm/meso_2_60.list')
