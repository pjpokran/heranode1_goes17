...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_vis_sqrt/latest_meso_2.jpg")
...
thefile = open('/whirlwind/goes17/grb/meso_vis_sqrt/meso_2_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_vis_sqrt/meso_2_30_temp.list','/whirlwind/goes17/grb/meso_vis_sqrt/meso_2_30.list')

thefile = open('/whirlwind/goes17/grb/meso_vis_sqrt/meso_2_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_vis_sqrt/meso_2_60_temp.list','/whirlwind/goes17/grb/meso_vis_sqrt/meso_2_60.list')
