...
filename90="/whirlwind/goes16/grb/meso_swir/latest_meso_1s.jpg"
...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_swir/latest_meso_1.jpg")
...
thefile = open('/whirlwind/goes16/grb/meso_swir/meso_1_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_swir/meso_1_30_temp.list','/whirlwind/goes16/grb/meso_swir/meso_1_30.list')

thefile = open('/whirlwind/goes16/grb/meso_swir/meso_1_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_swir/meso_1_60_temp.list','/whirlwind/goes16/grb/meso_swir/meso_1_60.list')
