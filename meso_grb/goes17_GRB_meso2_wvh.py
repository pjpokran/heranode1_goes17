...
filename9="/whirlwind/goes17/grb/meso_wvh/"+ctime_file_string+".jpg"
#filename9t="/tornado/home2/goes16_images/grb/meso_wvh/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_wvh/latest_meso_2.jpg")
#shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes17/grb/meso_wvh/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes17/grb/meso_wvh/meso_2_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvh/meso_2_30_temp.list','/whirlwind/goes17/grb/meso_wvh/meso_2_30.list')

thefile = open('/whirlwind/goes17/grb/meso_wvh/meso_2_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvh/meso_2_60_temp.list','/whirlwind/goes17/grb/meso_wvh/meso_2_60.list')
