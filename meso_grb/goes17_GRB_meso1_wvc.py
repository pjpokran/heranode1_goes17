...
if f.platform_ID == "G17":
    time_string = 'GOES-17 Mid-level water vapor (ABI ch 9)\n %s'%ctime_string
elif f.platform_ID == "G18":
    time_string = 'GOES-18 Mid-level water vapor (ABI ch 9)\n %s'%ctime_string
else:
    time_string = 'GOES-West Mid-level water vapor (ABI ch 9)\n %s'%ctime_string
...
filename9="/whirlwind/goes17/grb/meso_wvc/"+ctime_file_string+".jpg"
#filename9t="/tornado/home2/goes16_images/grb/meso_wvc/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_wvc/latest_meso_1.jpg")
#shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes17/grb/meso_wvc/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes17/grb/meso_wvc/meso_1_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvc/meso_1_30_temp.list','/whirlwind/goes17/grb/meso_wvc/meso_1_30.list')

thefile = open('/whirlwind/goes17/grb/meso_wvc/meso_1_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvc/meso_1_60_temp.list','/whirlwind/goes17/grb/meso_wvc/meso_1_60.list')
