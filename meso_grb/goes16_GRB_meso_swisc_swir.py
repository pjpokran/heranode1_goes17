...
fk12 = f2.variables['planck_fk1'][0]
fk22 = f2.variables['planck_fk2'][0]
bc12 = f2.variables['planck_bc1'][0]
bc22 = f2.variables['planck_bc2'][0]
#print("fk1 = ",fk1)
#print("fk2 = ",fk2)
#print("bc1 = ",bc1)
#print("bc2 = ",bc2)
...
data_var2 = (fk22 / ( np.log((fk12 / data_var2) + 1 )) - bc12) / bc22
...
im = ax9.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap=my_cmap, vmin=162., vmax=330., transform=proj)
im = ax9.imshow(a2[:], extent=(xa2[0],xa2[-1],ya2[-1],ya2[0]), origin='upper', cmap=my_cmap, vmin=162., vmax=330., transform=proj)
...
## color bar
cbaxes9 = fig9.add_axes([0.225,0.216,0.645,0.02])
...
time_string = 'GOES-16 Shortwave IR window (ABI ch 07)\n %s '%ctime_string
print(time_string)
...
filename9="/whirlwind/goes16/grb/meso_swir/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_swir/latest_meso_swisc_1.jpg")
shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes16/grb/meso_swir/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes16/grb/meso_swir/meso_swisc_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_swir/meso_swisc_30_temp.list','/whirlwind/goes16/grb/meso_swir/meso_swisc_30.list')

thefile = open('/whirlwind/goes16/grb/meso_swir/meso_swisc_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_swir/meso_swisc_60_temp.list','/whirlwind/goes16/grb/meso_swir/meso_swisc_60.list')
