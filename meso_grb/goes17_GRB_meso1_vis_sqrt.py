...
print("sqrt np.average(a) ",np.average(a))
#print(np.average(a))
...
filename9="/whirlwind/goes17/grb/meso_vis_sqrt/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_vis_sqrt/latest_meso_1.jpg")
#shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes17/grb/meso_vis_sqrt/*' + list_string)
file_list.sort()

thefile = open('/whirlwind/goes17/grb/meso_vis_sqrt/meso_1_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_vis_sqrt/meso_1_30_temp.list','/whirlwind/goes17/grb/meso_vis_sqrt/meso_1_30.list')

thefile = open('/whirlwind/goes17/grb/meso_vis_sqrt/meso_1_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_vis_sqrt/meso_1_60_temp.list','/whirlwind/goes17/grb/meso_vis_sqrt/meso_1_60.list')
