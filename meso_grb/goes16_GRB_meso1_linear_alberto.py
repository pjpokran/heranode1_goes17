...
#ax9.set_extent((-91.5,-88.0,41.0,45.0))
# LATLON
ax9.set_extent((-93.0,-78.0,19.0,35.0))
...
im = ax9.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1.0)
#im = ax9.imshow(a2[:], extent=(xa2[0],xa2[-1],ya2[-1],ya2[0]), origin='upper', cmap=my_cmap, vmin=162., vmax=330.)
...
#stn9 = ax9.text(-89.50, 43.02, 'MSN', transform=ccrs.Geodetic(), color='darkorange')
#stn9.set_path_effects(outline_effect)
#ax9.plot(-87.9065, 43.0389, 'bo', markersize=3, transform=ccrs.Geodetic())
#stn9 = ax9.text(-88.00, 42.98, 'MKE', transform=ccrs.Geodetic(), color='darkorange')
#stn9.set_path_effects(outline_effect)
...
#stn9 = ax9.text(-88.00, 41.82, 'ORD', transform=ccrs.Geodetic(), color='darkorange')
#stn9.set_path_effects(outline_effect)
##ax9.plot(-90.5083, 41.4496, 'bo', markersize=3, transform=ccrs.Geodetic())
##stn9 = ax9.text(-90.60, 41.30, 'MLI', transform=ccrs.Geodetic(), color='darkorange')
##stn9.set_path_effects(outline_effect)
##
...
filename9="/dustdevil/goes16/special/"+ctime_file_string+"vis_linear_alberto.jpg"
