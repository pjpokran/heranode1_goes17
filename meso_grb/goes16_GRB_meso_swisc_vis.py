...
filename9="/whirlwind/goes16/grb/meso_vis/"+ctime_file_string+".jpg"
filename9t="/tornado/home2/goes16_images/grb/meso_vis/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_vis/latest_meso_swisc_1.jpg")
shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes16/grb/meso_vis/*' + list_string)
file_list.sort()

thefile = open('/whirlwind/goes16/grb/meso_vis/meso_swisc_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_vis/meso_swisc_30_temp.list','/whirlwind/goes16/grb/meso_vis/meso_swisc_30.list')

thefile = open('/whirlwind/goes16/grb/meso_vis/meso_swisc_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_vis/meso_swisc_60_temp.list','/whirlwind/goes16/grb/meso_vis/meso_swisc_60.list')
