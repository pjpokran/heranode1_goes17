...
if f.platform_ID == "G17":
    time_string = 'GOES-17 Shortwave IR w/reflected daytime component (ABI ch 7)\n %s'%ctime_string
elif f.platform_ID == "G18":
    time_string = 'GOES-18 Shortwave IR w/reflected daytime component (ABI ch 7)\n %s'%ctime_string
else:
    time_string = 'GOES-West Shortwave IR w/reflected daytime component (ABI ch 7)\n %s'%ctime_string
...
filename9="/whirlwind/goes17/grb/meso_swir/"+ctime_file_string+".jpg"
#filename9t="/tornado/home2/goes16_images/grb/meso_swir/"+ctime_file_string+".jpg"
#filename90="/whirlwind/goes17/grb/meso_ircm/latest_meso_1s.jpg"
...
#fig90.savefig(filename90, bbox_inches='tight',pad_inches=0)
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_swir/latest_meso_2.jpg")
#shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes17/grb/meso_swir/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes17/grb/meso_swir/meso_2_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_swir/meso_2_30_temp.list','/whirlwind/goes17/grb/meso_swir/meso_2_30.list')

thefile = open('/whirlwind/goes17/grb/meso_swir/meso_2_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_swir/meso_2_60_temp.list','/whirlwind/goes17/grb/meso_swir/meso_2_60.list')
