#!/home/poker/miniconda3/envs/goes17_201811/bin/python
...
#print("vis_before, a",a)
# a = 0.

#print("nan? ",np.isnan(a))
#print(">1000? ",np.greater(a, 1000.))
#print("dqf ",qual_var)
...
print("lin np.average(a) ",np.average(a))
#if np.average(a) > 0.75:
#    quit()

#if np.average(a) < 0.025:
#    quit()
if np.average(a) < 0.005:
    quit()
...
if f.platform_ID == "G17":
    time_string = 'GOES-17 Band 2 Red Visible\n %s'%ctime_string
elif f.platform_ID == "G18":
    time_string = 'GOES-18 Band 2 Red Visible\n %s'%ctime_string
else:
    time_string = 'GOES-West Band 2 Red Visible\n %s'%ctime_string
...
filename9="/whirlwind/goes17/grb/meso_vis/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_vis/latest_meso_1.jpg")
#shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes17/grb/meso_vis/*' + list_string)
file_list.sort()

thefile = open('/whirlwind/goes17/grb/meso_vis/meso_1_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_vis/meso_1_30_temp.list','/whirlwind/goes17/grb/meso_vis/meso_1_30.list')

thefile = open('/whirlwind/goes17/grb/meso_vis/meso_1_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_vis/meso_1_60_temp.list','/whirlwind/goes17/grb/meso_vis/meso_1_60.list')
