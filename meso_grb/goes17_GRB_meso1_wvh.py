...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_wvh/latest_meso_1.jpg")
...
thefile = open('/whirlwind/goes17/grb/meso_wvh/meso_1_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvh/meso_1_30_temp.list','/whirlwind/goes17/grb/meso_wvh/meso_1_30.list')

thefile = open('/whirlwind/goes17/grb/meso_wvh/meso_1_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvh/meso_1_60_temp.list','/whirlwind/goes17/grb/meso_wvh/meso_1_60.list')
