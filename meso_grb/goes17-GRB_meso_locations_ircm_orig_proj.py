...
proj = ccrs.Geostationary(central_longitude=f.variables['nominal_satellite_subpoint_lon'][0],
                          ...
                          globe=globe,sweep_axis='x')
print("central longitude, nominal satellite subpoint lon ",f.variables['nominal_satellite_subpoint_lon'][0],
                          f.variables['nominal_satellite_height'][0] * 1000)
...
stn9.set_path_effects(outline_effect)
stn90 = ax90.text(plotlon, plotlat, "1", horizontalalignment='center', verticalalignment='center', transform=ccrs.Geodetic(), color='darkorange')
...
stn9.set_path_effects(outline_effect)
stn90 = ax90.text(plotlon, plotlat, "2", horizontalalignment='center', verticalalignment='center', transform=ccrs.Geodetic(), color='darkorange')
stn90.set_path_effects(outline_effect)
##
##
...
if f.platform_ID == "G17":
    time_string = 'GOES-17 Meso Sector Locations\nClean IR LW window (ABI ch 13)\n%s'%ctime_string
elif f.platform_ID == "G18":
    time_string = 'GOES-18 Meso Sector Locations\nClean IR LW window (ABI ch 13)\n%s'%ctime_string
else:
    time_string = 'GOES-West Meso Sector Locations\nClean IR LW window (ABI ch 13)\n%s'%ctime_string
print(time_string)
