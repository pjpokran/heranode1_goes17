...
if f.platform_ID == "G17":
    time_string = 'GOES-17 Low level water vapor (ABI ch 10)\n %s'%ctime_string
elif f.platform_ID == "G18":
    time_string = 'GOES-18 Low level water vapor (ABI ch 10)\n %s'%ctime_string
else:
    time_string = 'GOES-West Low level water vapor (ABI ch 10)\n %s'%ctime_string
...
filename9="/whirlwind/goes17/grb/meso_wvl/"+ctime_file_string+".jpg"
#filename9t="/tornado/home2/goes16_images/grb/meso_wvl/"+ctime_file_string+".jpg"
...
shutil.copy(filename9, "/whirlwind/goes17/grb/meso_wvl/latest_meso_2.jpg")
#shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes17/grb/meso_wvl/*' + list_string)
file_list.sort()
#print("file list is ",file_list)

thefile = open('/whirlwind/goes17/grb/meso_wvl/meso_2_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvl/meso_2_30_temp.list','/whirlwind/goes17/grb/meso_wvl/meso_2_30.list')

thefile = open('/whirlwind/goes17/grb/meso_wvl/meso_2_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes17/grb/meso_wvl/meso_2_60_temp.list','/whirlwind/goes17/grb/meso_wvl/meso_2_60.list')
