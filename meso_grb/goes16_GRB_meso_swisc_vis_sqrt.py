...
scalefactor2 = f2.variables['Rad'].scale_factor
add_offset2 = f2.variables['Rad'].add_offset
data_var2 = f2.variables['Rad'][:]
# Convert radiance to reflectance factor for Vis/NearIR (1-6)
data_var2 = data_var2 * f2.variables['kappa0'][0]
# reset values <0 to 0
data_var[data_var < 0.] = 0.
data_var2[data_var2 < 0.] = 0.
print("max of data_var ",np.max(data_var))
print("min of data_var ",np.min(data_var))
print("max of data_var2 ",np.max(data_var2))
print("min of data_var2 ",np.min(data_var2))
...
condition1=np.less(a2,0.91)
condition2=np.greater_equal(a2,0.91)
a2 =(condition1*np.sqrt(data_var2)) + (condition2*(0.9539 + (1.-(1.16-data_var2)/0.25)*0.0461))
...
if np.average(a2) < 0.025 and np.average(a) < 0.025 :
    quit()
...
ax90 = fig90.add_subplot(1, 1, 1, projection=proj)
ax90.outline_patch.set_edgecolor('none')
ax90.background_patch.set_fill(False)
ax90.outline_patch.set_edgecolor('black')
ax90.patch.set_facecolor('none')
ax90.set_extent((-91.3,-87.0,40.8,45.0))
...
#im = ax.imshow(a[wi_image_crop_top:wi_image_crop_bottom,wi_image_crop_left:wi_image_crop_right], extent=(xa[wi_image_crop_left],xa[wi_image_crop_right],ya[wi_image_crop_bottom],ya[wi_image_crop_top]), origin='upper',cmap='Greys_r', vmin=0., vmax=1., transform=proj2)
#im = ax2.imshow(a[mw_image_crop_top:mw_image_crop_bottom,mw_image_crop_left:mw_image_crop_right], extent=(xa[mw_image_crop_left],xa[mw_image_crop_right],ya[mw_image_crop_bottom],ya[mw_image_crop_top]), origin='upper',cmap='Greys_r', vmin=0., vmax=1., transform=proj2)
...
im = ax9.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1., transform=proj)
im = ax9.imshow(a2[:], extent=(xa2[0],xa2[-1],ya2[-1],ya2[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1., transform=proj)
im = ax90.imshow(a[:], extent=(xa[0],xa[-1],ya[-1],ya[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1., transform=proj)
im = ax90.imshow(a2[:], extent=(xa2[0],xa2[-1],ya2[-1],ya2[0]), origin='upper', cmap='Greys_r', vmin=0., vmax=1., transform=proj)
...
ax90.add_geometries(counties.geometries(), ccrs.PlateCarree(), edgecolor='darkgreen', facecolor='None')
...
ax90.add_feature(state_boundaries, linestyle=':',linewidth=2, edgecolor='magenta')
...
ax90.coastlines(resolution='10m', color='green')
...
ax90.add_feature(cfeat.BORDERS, linewidth='1', edgecolor='green')
...
ax9.plot(-89.4012, 43.0731, 'bo', markersize=3, transform=ccrs.Geodetic())
stn9 = ax9.text(-89.50, 43.01, 'MSN', transform=ccrs.Geodetic(), color='darkorange')
stn9.set_path_effects(outline_effect)
ax9.plot(-87.9065, 43.0389, 'bo', markersize=3, transform=ccrs.Geodetic())
stn9 = ax9.text(-88.00, 42.97, 'MKE', transform=ccrs.Geodetic(), color='darkorange')
stn9.set_path_effects(outline_effect)
ax9.plot(-91.2396, 43.8014, 'bo', markersize=3, transform=ccrs.Geodetic())
stn9 = ax9.text(-91.33, 43.75, 'LSE', transform=ccrs.Geodetic(), color='darkorange')
stn9.set_path_effects(outline_effect)
ax9.plot(-88.0198, 44.5192, 'bo', markersize=3, transform=ccrs.Geodetic())
stn9 = ax9.text(-88.11, 44.46, 'GRB', transform=ccrs.Geodetic(), color='darkorange')
stn9.set_path_effects(outline_effect)
ax9.plot(-87.9073, 41.9742, 'bo', markersize=3, transform=ccrs.Geodetic())
stn9 = ax9.text(-88.00, 41.91, 'ORD', transform=ccrs.Geodetic(), color='darkorange')
stn9.set_path_effects(outline_effect)
ax9.plot(-90.5083, 41.4496, 'bo', markersize=3, transform=ccrs.Geodetic())
stn9 = ax9.text(-90.60, 41.39, 'MLI', transform=ccrs.Geodetic(), color='darkorange')
stn9.set_path_effects(outline_effect)
#
...
time_var = f2.time_coverage_start
...
#filename9="/whirlwind/goes16/test/"+ctime_file_string+"_grb_meso.jpg"
filename9="/whirlwind/goes16/grb/meso_vis_sqrt/"+ctime_file_string+".jpg"
filename9t="/tornado/home2/goes16_images/grb/meso_vis_sqrt/"+ctime_file_string+".jpg"
filename90="/whirlwind/goes16/grb/meso_vis_sqrt/latest_swisc_s.jpg"
...
fig9.savefig(filename9, bbox_inches='tight',pad_inches=0, facecolor='black')
fig90.savefig(filename90, bbox_inches='tight',pad_inches=0, facecolor='black')
...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_vis_sqrt/latest_meso_swisc_1.jpg")
shutil.copy(filename9, filename9t)

import glob
file_list = glob.glob('/whirlwind/goes16/grb/meso_vis_sqrt/*' + list_string)
file_list.sort()

thefile = open('/whirlwind/goes16/grb/meso_vis_sqrt/meso_swisc_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_vis_sqrt/meso_swisc_30_temp.list','/whirlwind/goes16/grb/meso_vis_sqrt/meso_swisc_30.list')

thefile = open('/whirlwind/goes16/grb/meso_vis_sqrt/meso_swisc_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_vis_sqrt/meso_swisc_60_temp.list','/whirlwind/goes16/grb/meso_vis_sqrt/meso_swisc_60.list')
...
silentremove("/whirlwind/goes16/grb/vis/wi/latest_wi_72.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_71.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_72.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_70.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_71.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_69.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_70.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_68.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_69.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_67.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_68.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_66.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_67.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_65.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_66.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_64.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_65.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_63.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_64.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_62.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_63.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_61.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_62.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_60.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_61.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_59.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_60.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_58.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_59.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_57.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_58.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_56.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_57.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_55.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_56.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_54.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_55.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_53.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_54.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_52.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_53.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_51.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_52.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_50.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_51.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_49.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_50.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_48.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_49.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_47.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_48.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_46.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_47.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_45.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_46.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_44.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_45.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_43.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_44.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_42.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_43.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_41.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_42.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_40.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_41.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_39.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_40.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_38.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_39.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_37.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_38.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_36.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_37.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_35.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_36.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_34.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_35.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_33.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_34.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_32.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_33.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_31.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_32.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_30.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_31.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_29.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_30.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_28.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_29.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_27.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_28.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_26.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_27.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_25.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_26.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_24.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_25.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_23.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_24.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_22.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_23.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_21.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_22.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_20.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_21.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_19.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_20.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_18.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_19.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_17.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_18.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_16.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_17.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_15.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_16.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_14.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_15.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_13.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_14.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_12.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_13.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_11.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_12.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_10.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_11.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_9.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_10.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_8.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_9.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_7.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_8.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_6.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_7.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_5.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_6.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_4.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_5.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_3.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_4.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_2.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_3.jpg")
silentrename("/whirlwind/goes16/grb/vis/wi/latest_wi_1.jpg", "/whirlwind/goes16/grb/vis/wi/latest_wi_2.jpg")

shutil.copy(filename1, "/whirlwind/goes16/grb/vis/wi/latest_wi_1.jpg")
