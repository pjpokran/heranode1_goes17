...
shutil.copy(filename9, "/whirlwind/goes16/grb/meso_ircm/latest_meso_swisc_1.jpg")
...
thefile = open('/whirlwind/goes16/grb/meso_ircm/meso_swisc_30_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_ircm/meso_swisc_30_temp.list','/whirlwind/goes16/grb/meso_ircm/meso_swisc_30.list')

thefile = open('/whirlwind/goes16/grb/meso_ircm/meso_swisc_60_temp.list', 'w')
...
for item in thelist:
    ...
    thefile.write(tail + '\n')
thefile.close
os.rename('/whirlwind/goes16/grb/meso_ircm/meso_swisc_60_temp.list','/whirlwind/goes16/grb/meso_ircm/meso_swisc_60.list')
